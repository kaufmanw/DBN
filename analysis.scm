...
;;   
;; Postconditions
;;   error-rates is a list of numbers between 0 and 1
;;   (length error-rates) = 21
;;   (list-ref error-rates i) is the test error rate (averaged over 
;;     num-trials runs) of training a decision tree on i*5 examples
